 ...
 * this technique minimizes the number of opcodes thus improving performance speed wise (not memory wise though).
 * 
 ...
 * This doesn't take much time, but if you need 2 CPU cycles instead of 1 for basic operations, this means doubled costs/time.
 ...
 * storing single bits are not going to help in improving performance.
 ...
 * 
 * Bonus: BitSet can also be used as an alternative to boolean[] if one wishes.
